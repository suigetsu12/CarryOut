...
using SubscribeAndHandleQBEvent.PostgreSQL;
using Npgsql;
...
namespace SubscribeAndHandleQBEvent
{
    ...
    class SubscribeAndHandleQBEvent
    {
        ...
        private static string GetDataEventSubscriptionAddXML()
        {
            ...
            requestXMLDoc.AppendChild(requestXMLDoc.CreateProcessingInstruction("qbxml", "version=\"4.0\""));
            ...
            dataEventSubscriptionAdd.AppendChild(requestXMLDoc.CreateElement("SubscriberID")).InnerText = "{54EFE7BC-C884-4449-ACF8-FCABAC04F944}";
            ...
            comCallbackInfo.AppendChild(requestXMLDoc.CreateElement("CLSID")).InnerText = "{80552C03-B271-4cb2-B09F-0271E1DE808C}";

            //Delivery Policy
            dataEventSubscriptionAdd.AppendChild(requestXMLDoc.CreateElement("DeliveryPolicy")).InnerText = "DeliverAlways";
            dataEventSubscriptionAdd.AppendChild(requestXMLDoc.CreateElement("DeliverOwnEvents")).InnerText = "false";
            ...
            //Add Inventory Category List and operations
            listEventSubscription.AppendChild(requestXMLDoc.CreateElement("ListEventType")).InnerText = "ItemInventory";
            listEventSubscription.AppendChild(requestXMLDoc.CreateElement("ListEventOperation")).InnerText = "Add";
            listEventSubscription.AppendChild(requestXMLDoc.CreateElement("ListEventOperation")).InnerText = "Modify";
            listEventSubscription.AppendChild(requestXMLDoc.CreateElement("ListEventOperation")).InnerText = "Delete";
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                var postgreSqlListener = new PostgreListener();
                postgreSqlListener.ListenCustomChange();

                #region Inventory
                postgreSqlListener.ListenInventoryCategoryChange();
                postgreSqlListener.ListenItemInventoryChange();
                #endregion

                #region SaleOrder
                postgreSqlListener.ListenSalesOrderChange();
                #endregion

                Register();
                UnsubscribeForEvents(QBSubscriptionType.Data, true);
                SubscribeForEvents(QBSubscriptionType.Data, String.Empty);
