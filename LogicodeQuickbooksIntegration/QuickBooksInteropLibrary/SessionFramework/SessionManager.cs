...
namespace QuickBooksInteropLibrary.SessionFramework
{
    public class SessionManager
    {
        ...
        private static string _appName = "LogicodeQuickbookIntegration";                               // storage location for the application name
